...
// should be: float TempModel(float uref, float prev);
// with temp_model as global var in main
// with processes uniform enough, temp_model could be reset to temp_wax with each new reference
